...
fita1 = '000' + encoded_transitions + '000'
# Inicializa as fitas
fita2 = 'B' * len(fita1)  # Fita 2 é cheia de símbolos 'B' no início
fita3 = word + 'B' * (len(fita1) - len(word))  # Fita 3 inicia com a palavra de entrada e o restante com 'B'

# Inicializa a Máquina de Turing com as fitas.
tapes = [fita1, fita2, fita3]
initial_state = 'q0'
...
turing_machine.run(max_steps=10)
