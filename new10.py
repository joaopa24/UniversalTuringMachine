class MaquinaDeTuring:
    ...
    def tentar_proxima_transicao(self):
        ...
        while i < len(self.fita1) - 1:
            if (self.fita1[i] == estado_codificado and 
                ...
                self.mostrar_estado(transicoes_invalidas=True)
    ...
    def mostrar_estado(self, transicoes_invalidas=False):
        ...
        # Remove destaque da fita 1 e apenas retorna a fita sem colchetes
        fita1_com_transicao = fita1_com_transicao.replace('[', '').replace(']', '')
