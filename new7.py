class MaquinaDeTuring:
    ...
    def mostrar_estado(self):
        fita1_com_cabeca = ''.join(
            f"[{comp}]" if idx == self.cabeca_fita1 else comp
            for idx, comp in enumerate(self.fita1)
        )
        fita2_com_cabeca = ''.join(
            f"[{comp}]" if idx == self.cabeca_fita2 else comp
            for idx, comp in enumerate(self.fita2)
        )
        fita3_com_cabeca = ''.join(
            f"[{comp}]" if idx == self.cabeca_fita3 else comp
            for idx, comp in enumerate(self.fita3)
        )

        print("Fita 1:", fita1_com_cabeca)
        print("Fita 2:", fita2_com_cabeca)
        print("Fita 3:", fita3_com_cabeca)
